            ...
            <div class="flex mr-24 overflow-hidden relative w-full">
                <div class="z-10 relative text-white flex items-center text-white justify-center  text-white">
                    ...
                    <svg viewBox="0 0 200 200"
                         ...
                         xmlns="http://www.w3.org/2000/svg">
                        <path fill="#4299e1"
                              d="M40.5,-76.3C48.8,-65.4,49.4,-47.1,53.8,-33.2C58.2,-19.2,66.4,-9.6,68.4,1.1C70.4,11.9,66.1,23.8,59.5,34C53,44.2,44.1,52.7,33.8,60.8C23.5,69,11.8,76.8,-2.1,80.4C-15.9,84,-31.9,83.4,-39.8,73.9C-47.7,64.3,-47.6,45.9,-54.4,32.1C-61.2,18.3,-74.9,9.1,-78.8,-2.2C-82.6,-13.6,-76.6,-27.2,-67.8,-37.5C-59,-47.9,-47.4,-55,-35.7,-63.9C-23.9,-72.8,-11.9,-83.5,2.1,-87.1C16.1,-90.7,32.2,-87.1,40.5,-76.3Z"
