...
@section('content')
    ...
    <div class="container mx-auto flex justify-center items-center h-screen">
        ...
        <div class="bg-white py-5 px-10 pb-16 flex flex-wrap">
            <div class="w-full">
                <div class="flex justify-center items-center my-5 mb-10">
                    <svg class="h-5"
                         id="logo"
            ...
            <div class="w-full lg:w-1/2 mb-5 lg:mb-0">
                <h2 class="font-extrabold text-2xl">Welcome to this page</h2>
                <p>This page is made for people that have been asked to register on this part of the website. This means
                    that you are able to register your domain for the storage usage of this server.</p>
                <br/>
                <p>If you already have an account, please click <a class="text-blue-main"
                                                                   href="{{route('sharex.login')}}">here</a> to go to the login page.</p>
            </div>
            @if ($access)
                <div class="w-full lg:w-1/2 lg:px-20">
                    <form action="{{ route('sharex.register') }}"
                          method="post">
                        <div>
                            @csrf
                        </div>
                        ...
                        <div class="w-full lg:w-full mb-3 lg:pr-4">
                            <div class="flex flex-wrap items-center">
                                <label for="email"
                                       class="block text-gray-900 text-sm font-bold">
                                    E-mail <span class="text-xs text-red-500 -mt-2">*</span>
                                </label>
                            </div>
                            <input id="email"
                                   name="email"
                        ...
                        <div class="w-full lg:w-full mb-3 lg:pr-4">
                            <div class="flex flex-wrap items-center">
                                <label for="password"
                                       class="block text-gray-900 text-sm font-bold">
                                    Password <span class="text-xs text-red-500 -mt-2">*</span>
                                </label>
                            </div>
                            <input id="password"
                                   name="password"
                        ...
                        <div class="w-full lg:w-full mb-3 lg:pr-4">
                            <div class="flex flex-wrap items-center">
                                <label for="password"
                                       class="block text-gray-900 text-sm font-bold">
                                    Domain <span class="text-xs text-red-500 -mt-2">*</span>
                                </label>
                            </div>
                            <select class="shadow w-full appearance-none bg-white py-2 pl-2 px-10"
                                    name="domain">
                                <option value=""
                                        disabled
                                        selected>Please click to select your domain
                                </option>
                                <option value="hoopless.xyz">Hoopless.xyz</option>
                                <option value="kamerplant.xyz">Kamerplant.xyz</option>
                            </select>
                        </div>

                        <div class="mt-5">
                            <button class="ml-auto float-right cursor-pointer inline-block py-2 px-6 font-bold text-xs rounded text-white bg-blue-main hover:bg-green-dark uppercase shadow hover:shadow-md">
                                Register
                            </button>
                        </div>
                    </form>
            ...
            @else
                <div class="w-full lg:w-1/2 flex justify-center items-center text-center">
                    <div>
                        <p class="text-red-500 text-lg">The token is incorrect, please contact an administrator.</p>
                        <p class="font-italic text-sm">If you see this, the URL might be wrong or something went
                            wrong.</p>
                    </div>
                </div>
            @endif
