...
@section('title', 'Login ShareX Screenshots')

@section('content')

    <div class="containter mx-auto flex justify-center items-center h-screen">
        <div class="bg-white py-5 px-10 shadow-lg">
            ...
            <form action="{{route('sharex.login')}}"
                  method="post">
                <div>
                    @csrf
                </div>
                ...
                <div>
                    <div class="w-full lg:w-full mb-3 lg:pr-4">
                        ...
                        <input id="email"
                               ...
                               name="email"
                               required="required"
                               class="text-sm shadow appearance-none rounded w-64 py-2 px-3 outline-none ">
                    </div>
                </div>
                ...
                <div class="mt-5">
                    <button type="submit"
                            class="ml-auto float-right cursor-pointer inline-block py-2 px-6 font-bold text-xs rounded text-white bg-blue-main hover:bg-green-dark uppercase shadow hover:shadow-md">
                        Login
                    </button>
                </div>
            </form>
