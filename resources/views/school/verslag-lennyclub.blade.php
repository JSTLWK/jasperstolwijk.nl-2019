...
<div id="app">
    ...
    <div class="container mx-auto flex flex-wrap justify-center">
        <div class="w-full lg:w-4/5">
            <div class="w-full rounded-full text-lg bg-white text-blue-main -mt-7 flex items-center justify-center mb-16 shadow-lg">
                ...
                <a href="#contact"
                   class="w-1/3 p-3 text-center cursor-pointer hover:bg-gray-bg rounded-tr-full rounded-br-full">
                    Contact
                </a>
            </div>
        </div>
    ...
    <div class="container mx-auto flex flex-wrap justify-center text-gray-main px-20">
        ...
        <div class="w-2/4 mb-5 items-center justify-center flex">
            <a href="https://www.lennyclub.nl">
                <img class="h-56"
                     target="_blank"
                     src="https://www.lennyclub.nl/site/themes/lennyclub/assets/img/logo_lenny_club.png"
                     alt="Lennyclub Logo">
            </a>
        </div>
        ...
        <div class="w-1/3 pl-3 flex flex-wrap justify-center items-center">
            <a href="https://statamic.com/"
               target="_blank">
                <img
                    src="{{URL::asset('/img/school/lenny/statamic.png')}}"
                    class="h-56"
                    alt="Voorbeeld Statamic CMS">
            </a>
        </div>

        <div class="w-full">
            <h4 class="text-xl">Beginnen met bouwen</h4>
            <p class="text-sm mb-2">
                Nadat de basis elementen gemaakt worden, zoals de header, nav, footer icons, buttons, zijn we begonnen
                met de pagina’s te maken. Tijdens dit process probeerde ik zoveel mogelijk gelijk al dynamisch in te
                laden zodat ik later niet terug er om hoef te kijken nog kleine veranderingen te maken i.v.m. de content
                die wordt toegepast.

            </p>
            <p class="text-sm mb-2">
                Naast dat de pagina’s bestonden, de templates aangemaakt zijn, de basiselementen stonden ben ik begonnen
                met de addon “Aardvark SEO” toe te voegen Deze zorgt ervoor dat google snapt wat de pagina hier bedoeld
                wordt en dat de klant, in dit geval lennyclub, makkelijk de inhoud kon veranderen voor google zonder
                moeilijkheden of veel kennis ervan. Ook werd de addon ‘spock’ toegevoegd die ervoor zorgde dat de
                content (inhoud) van de website opgeslagen blijft en er geen kans is dat het verloren gaat.
            </p>

            <p class="text-sm mb-2">
                Nadat we alles hadden gedaan gingen we nog een keer een controle uitvoeren of we wel alles hadden gedaan
                we liepen alles nog een keer langs en zorgden ervoor dat alles werken zoals ze zouden moeten werken
                indien veranderen waar nodig met de juiste informatie.
            </p>
        </div>

        <div class="w-2/3">
            <h4 class="text-xl">Releasen van de website naar testomgeving</h4>
            <p class="text-sm mb-2">
                Omdat dit project binnen een kleine tijdsbestek af moest zijn en het ook niet ingewikkeld was zoals
                gedacht waren we hier minder dan 2 weken mee bezig om de website volledig af te krijgen binnen in, een
                voor mij nieuwe framework, tailwind met daaromheen laravel met statamic.
            </p>

            <p class="text-sm mb-2"> Na een gedoe om de de code aan elkaar aan te maken met wat wij beide hebben; kwamen
                we eruit hoe we
                alles goed ging zetten. Aangezien alles was getest op onze machines, kon het op de testomgeving ook
                allemaal goed gaan. Maar we hadden een fout. Er waren conflicten met onze code, dit betekend dat we
                moesten gaan uitzoeken welke code we moesten gebruiken. Dit duurde heel lang maar we kwamen er wel
                uiteindelijk. We waren wel een paar dingen vergeten om te testen en dat werkte in eerste instantie niet
                dus die moesten we gaan oplossen op onze machines en daarna zorgen dat het ook op de testomgeving. </p>

            <p class="text-sm mb-2">Daarna was het aan de klant om de inhoud zowel in het nederlands als in het frans in
                te vullen en
                feedback te geven op fouten/verbetering die hun tegenkomen op de website zodat dit nog opgelost kon
        ...
        <div class="w-1/3 pl-3 flex flex-wrap justify-center items-center">
            <a href="https://forge.laravel.com/"
               target="_blank">
                <img src="{{URL::asset('/img/school/lenny/laravel-forge.png')}}"
                     alt="Laravel forge homepage">
            </a>
        </div>

        <div class="w-full mb-5">
            <h4 class="text-xl">Release naar productie</h4>
            <p class="text-sm mb-2">Omdat dit project binnen een kleine tijdsbestek af moest zijn en het ook niet
                ingewikkeld was zoals gedacht
                waren we hier minder dan 2 weken mee bezig om de website volledig af te krijgen binnen in, een voor mij
                nieuwe framework, tailwind met daaromheen laravel met statamic.</p>
            <p class="text-sm mb-2">Na een gedoe om de de code aan elkaar aan te maken met wat wij beide hebben; kwamen
                we eruit hoe we alles
                goed ging zetten. Aangezien alles was getest op onze machines, kon het op de testomgeving ook allemaal
                goed
                gaan. Maar we hadden een fout. Er waren conflicten met onze code, dit betekend dat we moesten gaan
                uitzoeken
                welke code we moesten gebruiken. Dit duurde heel lang maar we kwamen er wel uiteindelijk. We waren wel
                een
                paar dingen vergeten om te testen en dat werkte in eerste instantie niet dus die moesten we gaan
                oplossen op
                onze machines en daarna zorgen dat het ook op de testomgeving.</p>
            <p class="text-sm mb-2"> Daarna was het aan de klant om de inhoud zowel in het nederlands als in het frans
                in te vullen en feedback
                te geven op fouten/verbetering die hun tegenkomen op de website zodat dit nog opgelost kon worden voor
                de
                release.</p>

            <h4 class="text-xl">Tot slot</h4>
            <p class="text-sm mb-2">Dit project was een van m’n eerste projecten binnen het bedrijf die tot een volledig
                geheel gemaakt moest
...
<script type="text/javascript"
        src="https://cdnjs.cloudflare.com/ajax/libs/baguettebox.js/1.11.0/baguetteBox.min.js"></script>
