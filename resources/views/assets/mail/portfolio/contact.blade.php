...
<table bgcolor="#F5F5F5" cellpadding="0" cellspacing="0" class="nl-container" role="presentation" style="table-layout: fixed; vertical-align: top; min-width: 320px; Margin: 0 auto; border-spacing: 0; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #F5F5F5; width: 100%;" valign="top" width="100%">
    ...
    <tr style="vertical-align: top;" valign="top">
        <td style="word-break: break-word; vertical-align: top;" valign="top">
                        ...
                        <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 15px; padding-left: 15px;">
                            ...
                            <div style="color:#008FA8;font-family:Tahoma, Verdana, Segoe, sans-serif;line-height:1.2;padding-top:0px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                                <div style="font-family: Tahoma, Verdana, Segoe, sans-serif; line-height: 1.2; font-size: 12px; color: #008FA8; mso-line-height-alt: 14px;">
                                    <p style="line-height: 1.2; font-size: 24px; mso-line-height-alt: 50px; margin: 0;"><span style="font-size: 24px;"><strong><span style="font-size: 24px;">Hallo {{ $user['name'] }},</span></strong></span></p>
                                </div>
                            </div>
                            ...
                            <div style="color:#555555;font-family:Tahoma, Verdana, Segoe, sans-serif;line-height:1.2;padding-top:0px;padding-right:10px;padding-bottom:30px;padding-left:10px;">
                                <div style="font-family: Tahoma, Verdana, Segoe, sans-serif; font-size: 12px; line-height: 1.2; color: #555555; mso-line-height-alt: 14px;">
                                    <p style="font-size: 14px; line-height: 1.2; mso-line-height-alt: 26px; margin: 0;"><span style="font-size: 14px;">Hartelijk dank voor uw e-mail. U krijgt zo snel mogelijk een reactie van mij. <br> <br> Inhoud van het bericht: </span></p>
                                    <div style="background-color: #E4E9ED; width: 100%; padding: 10px; font-size: 14px;">
                                        {{ $user['message'] }}
                                    </div>
                                </div>
                            </div>
            ...
            <div style="background-color:#4cb0c2; text-align: center; padding: 10px; color: #fff;">
                Copyright © <a style="color: #fff; text-decoration: none;" href="https://jasperstolwijk.nl">Jasperstolwijk.nl</a> All rights reserved.
            </div>
