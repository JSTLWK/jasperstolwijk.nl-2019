    ...
    <div class="w-full flex flex-wrap justify-center items-center">
        <div class="relative">
            <svg style="height: 400px;"
                 class="relative" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 144.811 86.345">
                <path id="blob_15_" data-name="blob (15)" d="M29.5-38.5c12.2.5,28,2.8,38.3,11.6S82.9-2.7,80.9,11.6c-2.1,14.4-11,27.8-23.8,32-12.7,4.3-29.4-.7-41.5-2.8s-19.8-1.4-32.4,1.7c-12.7,3.1-30.4,8.4-35,2.6-4.7-5.7,3.8-22.6,1.4-38S-66.1-22.3-63-28.6s22.7-5,36-5A139.252,139.252,0,0,0,.9-36.5,122.83,122.83,0,0,1,29.5-38.5Z" transform="translate(81.345 47.694) rotate(180)" fill="#4299e1"/>
            </svg>
            ...
            <div class="top-0 w-full flex h-full justify-center items-center absolute">
                <div class="">
                    ...
                    <div class="flex flex-col items-center text-white">
                        ...
                        <a href="{{ route('portfolio.home') }}" class="bg-purple-700 rounded-md cursor-pointer hover:bg-purple-600 text-white p-3 mr-5">
                            Go to homepage <i class="fas fa-arrow-right ml-3"></i>
                        </a>
                    </div>
                </div>
            </div>
